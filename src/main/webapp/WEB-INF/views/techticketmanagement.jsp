				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form:form action="searchTicketForTech" method="post"
							id="searchTicketForTech" class="searchTicketForTech"
							modelAttribute="searchTicketForTech">
							...
							<table data-toggle="table" data-url="${lastForteenList}"
								...
								<tbody>
									...
									<c:forEach var="list" items="${lastForteenList}">
										<tr>
											<td><a
												href="ticketItemDetailsT?recordID=<c:out value='${list.recordID}'/>">VTC000${list.recordID}</a></td>
											<td>${list.dateTime}</td>
											<td>${list.status}</td>
