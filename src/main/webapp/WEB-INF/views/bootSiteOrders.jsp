					...
					<div class="panel-body">
						...
						<div class="tab-content">
							...
							<form:form method="post" class="well form-horizontal"
								...
								<input type="hidden" id="partNumberList" name="partNumberList"
									class="form-control" value="" />
														...
														<div class="col-md-4">
															...
															<div class="btn-group" data-toggle="buttons">
																<label class="btn btn-primary"> <input
																	...
																	value="moveFromBootToHeadOffice" class="trigger"
																	data-rel="moveFromBootStockToHO">Head Office
																</label>
															</div>
															<br> <br>
																...
																<div class="form-group">
																	...
																	<div class="col-md-8 selectContainer">
																		<div class="input-group">
																			...
																			<textarea id="reasonForSite" name="reasonForSite"
																...
																<div class="form-group">
																	...
																	<div class="col-md-8 selectContainer">
																		<div class="input-group">
																			<span class="input-group-addon"><i
																				class="glyphicon glyphicon-edit"></i></span>
																			<textarea id="reasonForBoot" name="reasonForBoot"
																				class="form-control"></textarea>
