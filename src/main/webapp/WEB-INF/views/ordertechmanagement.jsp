				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button type="button" id="placeOrder"
							class="btn btn-success" name="placeOrder"
							value="Create Ticket"
							onclick="window.location.href='order.html'">Create
							Order</button>
						<br /> <br />

						<form:form action="searchOrderForTech" method="post"
							id="searchOrderForTech" modelAttribute="searchOrderForTech">
								...
								<div class="col-sm-12">
									...
									<br />
										<div class="col-xs-6 col-md-3">
											<a href='<c:url value="OrdersToReceive"/>'>
												<div class="well" style="background-color: #ffffff;">
													<h5 class="text-primary">
														<span class="label label-primary pull-right">${countOrdersReceive}</span>
														Orders to Receive
													</h5>
												</div>
											</a>
										...
										<div class="col-xs-6 col-md-3">
											<a href='<c:url value="pendingOrdersForTechnician"/>'>
												<div class="well" style="background-color: #ffffff;">
													<h5 class="text-primary">
						...
						<div class="tab-content">
							...
							<c:choose>
								...
								<c:when test="${heading=='Shipped' }">
									<div class="panel-heading" align="center">Orders to Receive</div>
								</c:when>								
								<c:when test="${heading=='Pending' }">
									<div class="panel-heading" align="center">Pending Orders</div>
								</c:when>
