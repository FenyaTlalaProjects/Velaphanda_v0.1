				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<c:if test="${empty serialNumber}">
							...
							<a target="_blank" href="deviceListDownloadPDF">Download PDF
							</a>
							<br />
							<br />
									...
									<c:forEach var="list" items="${deviceList}">
										<tr>
											<td class="details-control"
												onclick="window.location='displayDeviceHistory?serialNumber=<c:out value='${list.serialNumber}'/>';"></td>
											<td><a
						...
						<c:if test="${not empty serialNumber}">
							...
							<table id="deviceHistoryDetails" class="display">
								<thead>
									<tr>
										<th colspan="4" style="text-align: center;">History of Capturing Data for : ${serialNumber}</th>
									</tr>
									<tr>
										<th>Name</th>
										<th>Action</th>
