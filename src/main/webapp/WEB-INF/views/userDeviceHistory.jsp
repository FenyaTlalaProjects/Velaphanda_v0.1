						...
						<table id="deviceHistory" data-toggle="table" data-url="deviceHistoryList"
							...
							<tbody>
								...
								<c:forEach items="${tickets}" var="ticket">
									<tr>									
										<td><a
											href="userViewMoreDeviceHistory?recordID=<c:out value='${ticket.recordID}'/>">
												VTC000${ticket.recordID}</a></td>
										<td><c:out value="${ticket.dateTime}" /></td>
										<td><c:out value="${ticket.status}" /></td>
										<td><c:out
												value="${ticket.actionTaken}" /></td>
										<td><c:out
												value="${ticket.employee.firstName} ${ticket.employee.lastName}" /></td>
													<td><c:out value="" />Colour</td>
												<td><c:out value="" />Mono</td>
