				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<c:if test="${empty product.modelNumber}">
							...
							<form:form action="searchSerialNumberUserReplaceToner" method="post"
						...
						<c:if test="${not empty product.serialNumber }">
							...
							<form:form method="post" class="well form-horizontal"
								action="tonerReplaceUser" modelAttribute="tonerReplaceUser"
								id="logTicket">
													...
													<c:forEach var="list" items="${compitableSiteStock}">
														<tr>
															...
															<td><input type="checkbox"
																id="${list.partNumber}_compitableSiteStock" name="compitableSiteStock"
											...
											<div class="form-group">
												...
												<div class="col-md-8 inputGroupContainer">
													<div class="input-group">
														<span class="input-group-addon"><i
															class="glyphicon glyphicon-barcode"></i></span> <input
															id="currentColourReading" name="currentColourReading" placeholder="Color Reading"
															class="form-control" type="text">
													</div>
												</div>
											</div>
